    ...
    implements Sio.Type.Record
{
    ...
    public static class List {
        ...
        public final static boolean Equals(Address[] a, Address[] b){
            if (null == a)
                return (null == b);
            else if (null == b)
                return false;
     ...
     */
    public final static java.lang.String PREFIX = "store:";

    public final static java.lang.String Nil = null;

    public final static boolean Required = true;
    public final static boolean RequiredNot = false;

    public final static boolean PathU = true;
    public final static boolean PathUNot = false;

    /**
     * Tools used by the Address constructor.
     */
    public static class Ctor {
        public final static java.lang.String Parent(java.lang.String path){
        ...
        public final static java.lang.String Hex(int value){
            if (0 <= value)
                return alto.io.u.Hex.encode(value);
            else
                throw new IllegalArgumentException(java.lang.String.valueOf(value));
        }
        public final static java.lang.String Hex(long value){
            if (0L <= value)
                return alto.io.u.Hex.encode(value);
            else
                throw new IllegalArgumentException(java.lang.String.valueOf(value));
        }
        public final static java.lang.String Hex(Component value){
            if (null != value)
     ...
     * @see RType
     */
    protected Address(alto.sys.Reference ref)
        throws java.io.IOException
    {
        super(ref);
    }
    ...
    public Address(Component[] address){
        ...
        if (null != address)
            ...
            throw new alto.sys.Error.Argument("Null argument");
    }
        ...
        if (null == reference){
            ...
            if (null != parser){
                ...
                if (null != host && null != path)
                    reference = "http://"+Chbuf.fcat(host,path);
                else
                    reference = this.uri;
            }
    ...
    public final Component getComponent(int idx){
        if (0 > idx)
            ...
            Component[] address = this.address;
            if (null != address && idx < address.length)
                return address[idx];
            else
                return null;
        }
    ...
    public final Component[] getAddressClass(){
        ...
        if (len == address.length)
            ...
            throw new alto.sys.Error.State("Missing address depth");
    }
    /**
    ...
    public final boolean inRelation(Component c){
        ...
        if (null != relation)
            return (relation == c || relation.equals(c));
        else
            return false;
    }
    ...
    public final boolean isAddressBasePath(){
        Component[] address = this.address;
        if (null != address)
            return (Component.Path.LengthWith == address.length);
        else
            return false;
    }
    ...
    public final boolean equals(Object ano){
        if (ano == this)
            ...
            return false;
        else if (ano instanceof Address){
