 ...
 * @since 1.5
 */
public abstract class ConsumptionInputStream
    ...
    implements alto.sys.IO.Filter.Source
{
    ...
    public void enterTraceread(){
        if (0 == this.tracereadStack)
            this.tracereadLast = this.traceread;
        this.traceread = true;
    ...
    public void exitTraceread(){
        this.tracereadStack -= 1;
        if (0 == this.tracereadStack)
            this.traceread = this.tracereadLast;
        else if (0 > this.tracereadStack)
            this.tracereadStack = 0;
    }
    /**
    ...
    public final int read(byte buf[], int ofs, int len) throws java.io.IOException {
        if (this.isConsuming()){
            ...
            return this.in.read(buf,ofs,len);
    }
     ...
     */
    public final byte[] readMany(int many)
    ...
    public final int copyTo(alto.io.Output out)
        throws java.io.IOException
    {
