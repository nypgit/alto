...
public abstract class Tools 
    extends alto.io.u.Hex
{

    /**
     * The integer value zero.
     */
    public final static java.math.BigInteger ZERO = java.math.BigInteger.valueOf(0);
    /**
     * The integer value one.
     */
    public final static java.math.BigInteger ONE = java.math.BigInteger.valueOf(1);
    /**
     * The integer value two.
     */
    public final static java.math.BigInteger TWO = java.math.BigInteger.valueOf(2);
    /**
     * The integer value three.
     */
    public final static java.math.BigInteger THREE = java.math.BigInteger.valueOf(3);
    /**
     * The integer value four.
     */
    public final static java.math.BigInteger FOUR = java.math.BigInteger.valueOf(4);

    /**
     * @since 1.1
     */
    public final static int DigestLength(java.security.MessageDigest md){
        try {
    ...
    private final static java.util.Hashtable DIGLEN = new java.util.Hashtable();
    /**
     * @since Java 1.1
     */
    public final static int DigestLength(String algorithm){
     ...
     * @since Java 1.1
     */
    public final static int Digest(java.security.MessageDigest md, byte[] into, int into_ofs, int into_len){
        try {
     ...
     * necessary.
     */
    public final static byte[] Prepad(int blklen, byte[] in, int inofs, int inlen){
        if ( blklen <= inlen)
            return null;
        else {
    ...
    public final static byte[] Trim(byte[] in, int to){
        if (null == in)
            return null;
        else if (in.length <= to)
            return in;
        else {
    ...
    public final static byte[] Trim(byte[] in, int ofs, int to){
        if (null == in)
            return null;
        else if (0 != ofs){
            int inlen = in.length;
    ...
    public final static byte[] Trim(BigInteger bint){
    ...
    public final static void ComparisonPrint(byte[] ptext, byte[] ttext, java.io.PrintStream out){
