    ...
    static {
        try {
            ...
            VALUE_CLASSES[3] =        // ContentType
                Class.forName("alto.sec.util.ObjectIdentifier");
            ...
            VALUE_CLASSES[6] =        // Countersignature
                Class.forName("[Lalto.sec.pkcs.SignerInfo;");
            ...
            VALUE_CLASSES[14] =        // ExtensionRequest
                Class.forName("alto.sec.x509.CertificateExtensions");
    ...
    public String toString() {
        ...
        if (SINGLE_VALUED[index]) {
            if (value instanceof byte[]) { // special case for octet string
                ...
                buf.append(Hex.encode((byte[]) value));
            } else {
