...
public class OIDMap {
    ...
    // "user-friendly" names
    private static final String ROOT = X509Certificate.NAME + "." +
                                 X509CertInfo.NAME + "." +
