    ...
    implements DerEncoder 
{
    ...
    public void putLength(int len) throws IOException {
        ...
        } else if (len < DerValue.Encode.LengthMark1) {
            write(DerValue.Encode.LengthHead2);
            write((byte)len);

        } else if (len < DerValue.Encode.LengthMark2) {
            write(DerValue.Encode.LengthHead3);
            write((byte)(len >> 8));
            write((byte)len);

        } else if (len < DerValue.Encode.LengthMark3) {
            write(DerValue.Encode.LengthHead4);
            write((byte)(len >> 16));
            write((byte)(len >> 8));
            write((byte)len);

        } else {
            write(DerValue.Encode.LengthHead5);
            write((byte)(len >> 24));
            write((byte)(len >> 16));
            write((byte)(len >> 8));
            write((byte)len);
