...
public class Clar {
     ...
     */
    public Clar( java.io.InputStream in) throws java.io.IOException {
        super();
        read(in);
    }
     ...
     * @exception java.io.IOException Bad classfile format.
     */
    public Clar( byte[] in) throws java.io.IOException {
        super();
     ...
     * <tt>"alto.pi.pif.Clar.constant_pool"</tt>.
     * 
     ...
     * @see #getName
     */
    public byte[] write() throws java.io.IOException {
     ...
     */
    public final static void PrintCP ( Clar cla, java.io.PrintStream out){
     ...
     */
    public final static void PrintCP ( Clar cla, java.io.PrintStream out, boolean nesting){
