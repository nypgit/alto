...
public interface DFS
    extends alto.sys.IO.Location.Transient,
            JavaFileManager
{
    ...
    /**
     * @param timein Relative to epoch
     * @param timeout Relative to 'timein' (delta, number of milliseconds)
     */
    public void dfsNotifyLOCK(Address addr, long timein, long timeout)
        throws java.io.IOException;
